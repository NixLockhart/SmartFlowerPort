...
#define ATK_MW8266D_RST_GPIO_PORT_CLK       RCC_APB2ENR_IOPAEN

/* IO操作宏 */
#define ATK_MW8266D_RST(x)                  do{ if(x) { ATK_MW8266D_RST_GPIO_PORT->BSRR = ATK_MW8266D_RST_GPIO_PIN; } \
                                                else { ATK_MW8266D_RST_GPIO_PORT->BRR = ATK_MW8266D_RST_GPIO_PIN; } } while(0)
